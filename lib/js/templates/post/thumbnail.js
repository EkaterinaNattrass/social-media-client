...
const postThumbnailTemplate = exports.postThumbnailTemplate = function postThumbnailTemplate(post) {
  ...
  const footer = (0, _footer.postFooter)((0, _actions.postActions)(post), (0, _reactions.postReactionMenu)(post));
