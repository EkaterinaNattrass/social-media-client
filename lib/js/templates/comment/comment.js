...
const commentTemplate = exports.commentTemplate = function commentTemplate(comment) {
  let postOwner = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  const {
    name
  } = (0, _index.profile)();
  ...
  clone.querySelector('.owner').href = "./?view=profile&name=".concat(comment.owner);
